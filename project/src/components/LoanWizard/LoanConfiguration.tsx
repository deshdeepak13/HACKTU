        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-1">
              ...
              <div className="mt-2 flex justify-between text-sm text-gray-600">
                <span>12 months</span>
                <span className="font-medium text-blue-600">24 months</span>
                <span>60 months</span>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white shadow-sm rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="mt-2 text-2xl font-semibold text-gray-900">$1,137</p>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="mt-2 text-2xl font-semibold text-gray-900">8.5%</p>
          </div>
        </div>
